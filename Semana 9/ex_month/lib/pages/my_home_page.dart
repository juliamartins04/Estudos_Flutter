...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Text _checkMonthText() {
    return Text(MonthCheck.checkMonth(month.varMonth), style: const TextStyle(fontSize: 30),);
  }

  Text _checkText() {
    return Text("${month.varMonth ?? "mês não informado"}", style: const TextStyle(fontSize: 30),);
  }
